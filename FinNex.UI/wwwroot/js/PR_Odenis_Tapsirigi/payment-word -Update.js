document.addEventListener('DOMContentLoaded', function () {
    ...
    const btn = document.getElementById('btnGenerateWordUpdate');
    if (!btn) return;
    ...
    btn.addEventListener('click', async function () {
        ...
        try {
            const response = await fetch('/PR_Odenis_Tapsirigi/OdenisTapsirigi/EditVeWord', {
                method: 'POST',
                headers: {
