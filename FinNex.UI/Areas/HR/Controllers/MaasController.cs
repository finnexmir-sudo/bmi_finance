    ...
    public class MaasController : Controller
    {
        ...
        public async Task<IActionResult> ExcelIxrac(int il, int ay)
        {
            ...
            foreach (var m in maaslar)
            {
                ...
                decimal cixis = ProvodkaIzahMeblegCem(m.HesablamaIzahi, "Çıxış Kəsintisi");   // işdən çıxan — işlənməyən gün
                ...
                pul[4]  = esas - davam - cixis;                   // Hesablanmış (işlənmiş) əmək haqqı — çıxış daxil
