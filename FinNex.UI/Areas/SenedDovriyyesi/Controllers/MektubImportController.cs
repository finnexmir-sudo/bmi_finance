...
/// <summary>
/// BMI (Oracle) məktub jurnallarının FinNex-ə birdəfəlik köçürülməsi.
/// Yalnız Admin — bu, tarixi datanın köçürülməsidir, gündəlik əməliyyat deyil.
/// </summary>
[Area("SenedDovriyyesi")]
[Authorize(Roles = RoleNames.Admin)]
public class MektubImportController : Controller
{
    private readonly IMektubImportService _service;

    public MektubImportController(IMektubImportService service)
    {
        _service = service;
    }

    // GET: /SenedDovriyyesi/MektubImport
    public async Task<IActionResult> Index(CancellationToken ct)
    {
        ...
        if (!res.Success)
        {
            ...
            return View(new Application.DTOs.Mektub.MektubImportVeziyyetDto());
        }
        return View(res.Data ?? new Application.DTOs.Mektub.MektubImportVeziyyetDto());
    }

    // POST: /SenedDovriyyesi/MektubImport/Il
