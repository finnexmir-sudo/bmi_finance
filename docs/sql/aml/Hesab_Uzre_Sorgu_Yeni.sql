...
-- Mənbə: BMI/BMI/AML/frmhesabsorgu.cs → axtar()  (Fiziki şəxs variantı)
-- Tarix: 19.08.2026
--
-- ⚠️  YALNIZ SELECT — Oracle (BMI) yazma üçün deyil.
-- ⚠️  BU SORĞU HƏLƏ İCRA EDİLMƏYİB. Aşağıdakı sütunlar istifadəçinin
--     ekran görüntüsü/qeydi əsasında qəbul edilib, bazada YOXLANMALIDIR:
...
--     Biri yoxdursa ORA-00904 verəcək — hansı olduğunu yaz, dəyişdirərəm.
--
-- İSTİFADƏ: yalnız aşağıdakı `prm` blokunu dəyiş — hesab № və iki tarix.
-- ══════════════════════════════════════════════════════════════════════════
