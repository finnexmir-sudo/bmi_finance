...
public static class ServiceRegistration // Class mütəq mütəq static olmalıdır
{
    public static void AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<FinNex.Application.Interfaces.Valyuta.IBmiValyutaService, FinNex.Application.Services.Valyuta.BmiValyutaService>();
        ...
        services.AddScoped<IMuqavileSayghacService, MuqavileSayghacService>();
        services.AddScoped<IMuqavileSayghacImportService, MuqavileSayghacImportService>();
