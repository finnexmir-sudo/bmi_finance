...
{
    /// <inheritdoc />
    public partial class dbBaza : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Əsas Əməkhaqqı", true, null, false, null, 1, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8197), null, null },
                    { 2, "Bonus/Mükafat", true, null, false, null, 1, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8211), null, null },
                    { 3, "Məzuniyyət Ödənişi", true, null, false, null, 1, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8211), null, null },
                    { 4, "Davamiyyət Kəsintisi", true, null, false, null, 2, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8211), null, null },
                    { 5, "Gecikdirmə Cəriməsi", true, null, false, null, 2, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8211), null, null },
                    { 6, "Gəlir Vergisi", true, null, false, null, 2, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8211), null, null },
                    { 7, "DSMF (İşçi)", true, null, false, null, 2, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8216), null, null },
                    { 8, "İşsizlik Sığortası (İşçi)", true, null, false, null, 2, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8216), null, null },
                    { 9, "İTSS", true, null, false, null, 2, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8216), null, null },
                    { 10, "DSMF (İşəgötürən)", true, null, false, null, 3, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8216), null, null },
                    { 11, "İşsizlik Sığortası (İşəgötürən)", true, null, false, null, 3, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8216), null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "2026", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 14m, 1, null, false, null, 1, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8342), null, null },
                    { 2, "2026", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3m, 2, null, false, null, 1, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8347), null, null },
                    { 3, "2026", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 0.5m, 3, null, false, null, 1, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8347), null, null },
                    { 4, "2026", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 2m, 4, null, false, null, 1, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8352), null, null },
                    { 5, "2026", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 345m, 5, null, false, null, 2, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8352), null, null },
                    { 6, "2026", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 200m, 6, null, false, null, 2, null, new DateTime(2026, 3, 31, 9, 20, 0, 952, DateTimeKind.Local).AddTicks(8352), null, null }
                });
